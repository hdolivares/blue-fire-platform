...
// Single source of truth for BlueFire typefaces (app + landing).
// Self-hosted woff2 (vendored from Fontsource) — no build-time network fetch.
...
// Convenience: all three CSS variable classes, space-joined.
export const brandFontVars = `${archivo.variable} ${instrument.variable} ${mono.variable}`;
